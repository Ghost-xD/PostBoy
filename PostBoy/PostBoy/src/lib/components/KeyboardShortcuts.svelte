<script lang="ts">
  ...
  const sections: ShortcutSection[] = [
    ...
    { title: 'Navigation', items: [
      { keys: 'Ctrl + R', label: 'Reload app' },
      { keys: 'Ctrl + T', label: 'New tab' },
      { keys: 'Ctrl + W', label: 'Close current tab' },
      { keys: 'Control + Tab', label: 'Next tab' },
      { keys: 'Control + Shift + Tab', label: 'Previous tab' },
    ...
    { title: 'Tools', items: [
      ...
      { keys: 'Control + Shift + Q', label: 'SQL Query Runner' },
      ...
      { keys: 'Option + P', label: 'Previous diff change (in Diff Tool)', sub: true },
