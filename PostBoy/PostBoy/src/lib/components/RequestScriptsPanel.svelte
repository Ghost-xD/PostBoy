<script lang="ts">
  ...
  let scriptSection: 'pre' | 'test' = $state('pre');
...
<div class="scripts-section">
  ...
  {#if scriptSection === 'pre'}
    <p class="scripts-hint">Runs before auth and send. Use <code>pm.request</code>, <code>pm.variables</code>, <code>pm.console.log</code>.</p>
    <VariableInput
      multiline
      rows={14}
