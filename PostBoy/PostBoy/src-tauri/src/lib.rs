        ...
        .invoke_handler({
            #[cfg(feature = "chatbot")]
            {
                tauri::generate_handler![
                    ...
                    commands::db_create_request_example,
                    commands::db_get_request_examples,
                    commands::db_delete_request_example,
                    ...
                    commands::db_get_global_variables,
                    commands::db_set_global_variable,
                    commands::db_delete_global_variable,
                    commands::db_clear_global_variables,
                    commands::db_list_environments,
                    commands::db_create_environment,
                    commands::db_update_environment,
                    commands::db_delete_environment,
                    commands::db_duplicate_environment,
                    commands::db_get_environment_variables,
                    commands::db_set_environment_variable,
                    commands::db_delete_environment_variable,
                    commands::db_clear_environment_variables,
                    commands::db_reset_environment_variables,
